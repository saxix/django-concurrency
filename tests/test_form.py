...
# from tests.util import with_all_models, unique_name, refetch
#
#
# @with_all_models
...
# # @with_all_models
# @pytest.mark.django_db
# def test_conflict(model_class=SimpleConcurrentModel):
#     instance = model_class.objects.create(username=unique_name(20))
#     Form = modelform_factory(model_class, ConcurrentForm)
#     form = Form(data={}, instance=instance)
#
#     refetch(instance).save()  # conflict here
...
# #     def setUp(self):
# #         self.obj = SimpleConcurrentModel.objects.create(name='foo')
# #
# #     def test_conflict(self):
# #         form = modelform_factory(ConcurrentForm(instance=self.obj)
